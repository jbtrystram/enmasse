...
public class Versioned<T> {
     ...
     */
    public org.eclipse.hono.deviceregistry.Versioned<T> update(final Optional<String> resourceVersion, final Supplier<T> newContent) {

        Objects.requireNonNull(resourceVersion);

        if (isVersionMatch(resourceVersion)) {
            return new org.eclipse.hono.deviceregistry.Versioned<>(newContent.get());
        }
